                    ...
                    <form id="mainfrom" action="frminsert.php" method="POST">
                        <div class="form">
                            <div class="form-group">
                                <label for="plantecoepidemics">กรุณาเลือกชนิดของพืชเศรษฐกิจ</label>
                                <select name="plantecoepidemics" id="plantecoepidemics" class="form-control" required>
                                    <option value=""></option>
                            ...
                            <div class="form-group">
                                <label for="dataepidemics">กรุณาเลือกโรคระบาด</label>
                                <select name="dataepidemics" id="dataepidemics" class="form-control" required>
                                    <option value=""></option>
                                </select>
                            </div>
                            <div class="form-group">
