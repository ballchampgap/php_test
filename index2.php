                    ...
                    <form id="mainfrom" action="frminsert2.php" method="POST">
                        <div class="form">
                            <div class="form-group">
                                <label for="plantecopests">กรุณาเลือกชนิดพืชเศรษฐกิจ</label>
                                <select name="plantecopests" id="plantecopests" class="form-control" required>
                                    <option value=""></option>
                            ...
                            <div class="form-group">
                                <label for="datapests">กรุณาเลือกชนิดของพืชเศรษฐกิจ</label>
                                <select name="datapests" id="datapests" class="form-control" required>
                                    <option value=""></option>
                                </select>
                            </div>
                            <div class="form-group">
